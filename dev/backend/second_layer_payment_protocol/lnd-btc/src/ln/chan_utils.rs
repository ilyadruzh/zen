...
// Различные функции for key derivation and transaction creation for use within channels. В основном
// используется в Channel и ChannelMonitor.
...
// Определение транзакции создающее ключи
...
// Реализация транзакции создающее ключи
impl TxCreationKeys {
