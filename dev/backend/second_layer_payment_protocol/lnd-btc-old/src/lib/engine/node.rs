...
// fn receive_transaction(socket: TcpStream, data: Vec<u8>) -> Transaction {
    fn receive_transaction(socket: TcpStream, data: Vec<u8>) -> bool {
...
fn is_it_tx_in_blockchain() -> isize {
...
// fn create_after_timelock_transaction() -> Transaction {
    fn create_after_timelock_transaction() -> bool {

    // let timeunlock_tx: Transaction;
        let timeunlock_tx: bool = true;
...
fn create_commitment_tx() -> bool {
    // fn create_commitment_tx() -> Transaction {
